 ...
 *
 * These are the statements in `platform/cloudflare/sql/`, with the database
 * argument curried away. The SQL behind them is plain SQLite and would survive a move to
...
import type { NodeState } from "../../core/domain/node-state";
