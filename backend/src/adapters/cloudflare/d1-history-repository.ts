 ...
 *
 * The statements themselves stay in `db/chain-history`, where they are tested
...
import {
  ...
  readHourlyHistory,
  writeSnapshot,
} from "../../db/chain-history";
import type { ChainSnapshot } from "../../domain/chain-snapshot";
import type { ChainHistoryPoint, HistoryRepository } from "../../ports/persistence";
