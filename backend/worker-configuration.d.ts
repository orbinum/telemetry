/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 15b369b5cc257a5d02b8c6bb62a5da8d)
...
interface __BaseEnv_CloudflareBindings {
	...
	TELEMETRY_CHAINS: "";
	CHAIN: DurableObjectNamespace<import("./src/index").ChainDO>;
	GATEWAY: DurableObjectNamespace<import("./src/index").GatewayDO>;
	SUBMIT_LIMITER: RateLimit;
	FEED_LIMITER: RateLimit;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ChainDO" | "GatewayDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TELEMETRY_TESTNET_GENESIS" | "TELEMETRY_MAINNET_GENESIS" | "TELEMETRY_CHAINS">> {}
}
